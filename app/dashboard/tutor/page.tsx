    ...
    <div className="flex h-screen overflow-hidden bg-[#0f151c]">
      ...
      <main className="flex flex-1 flex-col gap-6 overflow-y-auto p-4 pt-18 md:p-8 md:pt-8">
        ...
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <StatCard label="Alumnos asignados" value={alumnos.length} sub="↑ Este cuatrimestre" subColor="text-emerald-400" icon={Users} accent="green" />
          <StatCard label="Sesiones este mes" value={sesiones.length} sub="↑ 3 más que el mes anterior" subColor="text-emerald-400" icon={CalendarDays} accent="green" />
          ...
          <SectionCard>
            ...
            <div className="flex flex-col gap-2 p-4">
              {PROXIMAS_SESIONES.map((p) => (
                <div key={p.id} className="flex items-center gap-3 rounded-lg border border-white/5 bg-white/3 px-4 py-3 transition-colors hover:border-emerald-500/30">
                  <div className="min-w-9 text-center">
                    <p className="text-xl font-extrabold leading-none text-emerald-400">{p.dia}</p>
